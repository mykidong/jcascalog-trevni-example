...
import cascading.avro.TrevniScheme;
...
public class ReadSpecifedColumnsWithTrevniScheme extends Configured
	implements Tool{
	...
	public int run(String[] args) throws Exception {
		...
		hadoopConf.set("trevni.meta.trevni.codec", codec);
		...
		TrevniScheme inputScheme = new TrevniScheme(inputSchema);
		inputScheme.setSourceFields(new Fields("?address-code", "?event-list"));
		
		TrevniScheme outputScheme = new TrevniScheme(outputSchema);
	...
	public static void main(String[] args) throws Exception
	{
		...
		ToolRunner.run(conf, new ReadSpecifedColumnsWithTrevniScheme(), args);
	}
