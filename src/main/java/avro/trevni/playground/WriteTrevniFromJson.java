...
public class WriteTrevniFromJson extends Configured implements Tool{	
	
	private static final String AVRO_OUTPUT_SCHEMA = "/META-INF/avro/electric-power-usage.avsc";
	
	private Schema outSchema;	
	
	public static class WriteTrevniFromJsonMapper extends Mapper<Object, Text, AvroKey<GenericRecord>, NullWritable> {
	...
	public int run(String[] args) throws Exception {	
		...
		job.setMapperClass(WriteTrevniFromJsonMapper.class);	
	...
	public static void main(String[] args) throws Exception
	{
		...
		ToolRunner.run(conf, new WriteTrevniFromJson(), args);
	}
